...
func _ready():
	...
	HighscorePopup = get_tree().get_root().get_node("Main").get_node("HUD").get_node("Control").get_node("HighScorePopup")
	HighscorePopupList = get_tree().get_root().get_node("Main").get_node("HUD").get_node("Control").get_node("HighScorePopup").get_node("ItemList")
...
#	StatusLabel = get_tree().get_root().get_node("Main").get_node("HUD_SCENE").get_node("Control").get_node("GameStatus")
	...
	ResetButton = get_tree().get_root().get_node("Main").get_node("HUD").get_node("Control").get_node("Reset_Button")
	HighscoreButton = get_tree().get_root().get_node("Main").get_node("HUD").get_node("Control").get_node("Highscore_Button")
